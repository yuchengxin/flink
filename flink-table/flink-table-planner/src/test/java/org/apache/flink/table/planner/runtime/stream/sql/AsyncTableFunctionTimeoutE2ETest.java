 ...
 * {@code AsyncLookupJoinTimeoutE2ETest}; this class intentionally narrows the surface to the {@code
 * AsyncTableFunction} contract owner.
 */
class AsyncTableFunctionTimeoutE2ETest {
     ...
     */
    @Test
    void testCustomTimeoutReturnsDefaultRow() throws Exception {
        tEnv.getConfig()
                .set(
                        ExecutionConfigOptions.TABLE_EXEC_ASYNC_LOOKUP_TIMEOUT,
                        Duration.ofMillis(200));
     ...
     */
    @Test
    void testCustomTimeoutEmptyCollectionPadsNullsForLeftOuterJoin() throws Exception {
        tEnv.getConfig()
                .set(
                        ExecutionConfigOptions.TABLE_EXEC_ASYNC_LOOKUP_TIMEOUT,
                        Duration.ofMillis(200));
     ...
     */
    @Test
    void testTimeoutMethodOverloadResolvesToMatchingSignature() throws Exception {
        tEnv.getConfig()
                .set(
                        ExecutionConfigOptions.TABLE_EXEC_ASYNC_LOOKUP_TIMEOUT,
                        Duration.ofMillis(200));
     ...
     * AsyncCorrelateTimeoutE2ETest#testTimeoutNotCompletingFutureFailsFast}. The UDF here returns
