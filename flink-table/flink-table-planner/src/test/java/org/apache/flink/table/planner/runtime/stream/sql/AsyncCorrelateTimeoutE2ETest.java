 ...
 * lookup-join coverage in {@code AsyncTableFunctionTimeoutE2ETest} / {@code
 * AsyncLookupJoinTimeoutE2ETest}. Drives the correlate path through {@code
 ...
 * </ul>
 */
class AsyncCorrelateTimeoutE2ETest {
    ...
    @Test
    void testCustomTimeoutReturnsEmptyCollectionForCorrelateQuery() throws Exception {
    ...
    @Test
    void testCustomTimeoutReturnsMultipleRowsForCorrelateQuery() throws Exception {
