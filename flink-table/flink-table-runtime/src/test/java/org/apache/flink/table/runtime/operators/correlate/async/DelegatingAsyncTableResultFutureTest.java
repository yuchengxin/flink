...
class DelegatingAsyncTableResultFutureTest {
    ...
    @Test
    void identityWrappingForwardsCollectionUnchanged() {
        // needsWrapping=false → wrapFunction is identity; the original collection must reach
        ...
        assertThat(downstream.completed.get()).isSameAs(outs);
